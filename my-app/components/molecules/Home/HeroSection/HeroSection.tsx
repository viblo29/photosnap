  ...
  return (
    <div className="w-screen h-auto flex flex-col items-center justify-center mt-18">
      ...
      >
        ...
        >
          <div
            className="absolute w-1.5 h-76 inset-0 top-43.25 
          ...
          <div className="w-96.75 h-76 max-[700px]:w-79.5 max-[700px]:h[275px]">
            <h1
              className="text-[40px] font-bold tracking-[4.17px] leading-12
        ...
        <div
          className="w-[58%] h-162.5   
                          max-[1200px]:w-[36%]
                          max-[700px]:w-full max-[700px]:h-73.75 max-[700px]:order-1"
        >
          <img src="/images/N1.webp" className="w-full h-full object-cover" />
        </div>
      </div>
      ...
      >
        <div
          className="w-[58%]  max-[1200px]:w-[36%] overflow-hidden
        ...
        <div
          className="bg-white text-black w-[42%] h-150 flex justify-center items-center  max-[1200px]:w-[64%]
