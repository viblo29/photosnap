    ...
    <div>
      <div className="w-full flex flex-col items-center mt-16 md:mt-28 lg:mt-30">
        <div className="mb-12 flex gap-8 items-center">
          <div
            className={`font-bold text-[18px]/[25px] transition-opacity duration-300 ${!isYearly ? "opacity-100" : "opacity-50"}`}
          >
            Monthly
          </div>
          <button
      ...
      <div className="w-screen flex flex-col items-center my-16 md:my-28 lg:my-40">
        <div className="hidden md:flex lg:flex uppercase font-bold text-[40px]/[48px] tracking-[4.17px] md:mb-16 lg:mb-14">
          Compare
        </div>
