      ...
      <div className='hidden md:hidden lg:flex'>
        ...
        <div className='relative z-10 px-7.5 md:px-0 md:flex md:items-center '>
          ...
          <div className='md:flex md:justify-between md:w-full md:items-center'>
            <div className='md:w-100 mt-14.5 md:mt-0 md:ml-8.25 lg:ml-39.75 text-white font-bold text-[32px]/[40px] md:text-[40px]/[48px] md:tracking-[4.17px] tracking-[3.33px] uppercase '>We’re in beta. Get your invite today!</div>
