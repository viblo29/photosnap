...
function HeroStory() {
  return (
    <div
      className="relative w-screen h-162.5 overflow-hidden group z-0 mt-18
    ...
    >
      ...
      <div
        className='absolute inset-0 z-2 bg-[url("/images/StoryActive.svg")]
                          bg-cover bg-center
                          opacity-0
      ...
      ></div>
      <div
        className="absolute left-24 top-30 z-3 w-96.75 h-105 flex flex-col items-start justify-between text-white    
                          max-[800px]:left-10 
                          max-[470px]:relative max-[470px]:top-13 max-[470px]:w-79.5 max-[470px]:left-8"
      >
        <div className="h-4 font-bold text-[12px] leading-[100%] tracking-[2px]">
          LAST MONTH’S FEATURED STORY
        </div>
        <div className="h-36 font-bold text-[40px] leading-12 tracking-[4.17px] max-[470px]:text-[32px] max-[470px]:">
        ...
        <div className="font-normal text-[15px] leading-6.25 tracking-[0] opacity-60">
        ...
        <div>
          <HomePageButton text="READ THE STORY" textColor="white" gap={4.5} />
        </div>
      </div>
    </div>
  );
