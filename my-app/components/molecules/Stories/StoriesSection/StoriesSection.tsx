        ...
        >
            ...
            <div className="px-10 pb-5 pt-90.25 flex flex-col items-start">
              <div className="flex flex-col items-start">
                <div className="mb-4 text-white">
                  <h1 className=" font-bold text-[18px] leading-6.25 tracking-[0px] mb-1">
                    {story.title}
                  </h1>
                  <p className="font-normal text-[13px] leading-[100%] tracking-[0px]">
                    {story.author}
                  </p>
                </div>
          ...
          >
            <div className="mb-10 mt-90.25 flex flex-col items-start w-full">
              <div className="mb-4 text-white  ">
                <p className="  mb-1 font-normal text-[13px] leading-[100%] tracking-[0px]"
                >{story.date}</p>
                <h1 className="   font-bold text-[18px] leading-6.25 tracking-[0px] mb-1">
                  {story.title}
                </h1>
